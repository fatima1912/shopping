...
var successMsg=req.flash('success')[0];
 ...
 res.render('shopping/index', { title: 'Shopping Cart',products:productChunks,successMsg:successMsg,noMessages:!successMsg });
});
});
 // res.render('shopping/index', { title: 'Shopping Cart'});
...
router.post('/checkout',isLoggedIn,function(req,res,next){
  ...
  var cart=new Cart(req.session.cart);
  var stripe = require("stripe")("sk_test_9rgkgMdBdY5DmxKhklEsB9Ki");
